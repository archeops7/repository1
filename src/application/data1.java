...
public class data1 {
	...
	public  data1(String date, double km, double totalKm, double litter, double totalLitter, double mileage, double aveMileage, int price, int cost, int totalCost, String memo) {
